...
public class DialogueManagerNewGame : MonoBehaviour
{
    public static DialogueManagerNewGame instance;
    ...
    private void Update()
    {
        ...
        else if (Input.GetKeyDown(KeyCode.Space) && story.currentChoices.Count == 0)
        {
            ...
            if (instance.story.canContinue)
            {
                ...
                if (instance.story.currentChoices.Count != 0)
                {
